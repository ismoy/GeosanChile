...
import auto_main from "@/assets/geosan_auto.webp";
type Props = {
...
const Dashboard = ({ setSelectedPage }: Props) => {
  ...
  return (
    <>
    {
      ...
      <motion.div
      className="mx-auto w-5/6 items-center justify-start md:flex md:h-6/6 bg-cover bg-center bg-no-repeat  mt-20 border border-blue-color rounded-md"
        onViewportEnter={() => setSelectedPage(SelectedPage.Dashboard)}
      >
         <div className="mx-auto w-9/12">
            <img src={auto_main} width={1080}></img>
           </div>
           <div className="z-10 mt-20 md:basis-1/6">
           <motion.div
            className="md:-mt-20"
            initial="hidden"
            whileInView="visible"
          ...
          >
             ...
             <div className="mx-auto w-10/12 bg-primary-300 bg-opacity-60 rounded-lg p-4 mt-4 ">
      ...
      {/* IMAGE AND MAIN HEADER */}
      <motion.div
      className="mx-auto w-full items-center justify-start md:flex md:h-6/6 bg-cover bg-center bg-no-repeat  mt-20 border border-blue-color rounded-md"
        onViewportEnter={() => setSelectedPage(SelectedPage.Dashboard)}
      >
         <div className="mx-auto w-full mt-8">
            <img src={auto_main}></img>
           </div>
           <div className="z-10 mt-2 mb-8 md:basis-1/6">
           <motion.div
            className="md:-mt-20"
            initial="hidden"
            whileInView="visible"
